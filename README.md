...
병합(merge)을 하면 새 브랜치에서 실험하고 실험 성공시에만 안전하게 main에 저장됨. 공동의 프로젝트에서 협업 시 각자 브랜치에서 작업 후 main으로 병합하면 서로의 코드를 건드리지 않고 안전하게 합칠 수 있음.
